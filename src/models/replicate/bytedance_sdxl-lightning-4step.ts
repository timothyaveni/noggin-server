...
type UnevaluatedModelParams = {
  ...
  'guidance-scale': ModelInput_Number_Value;
};
...
export const streamResponse: StreamModelResponse = async (
  ...
  const input = {
    ...
    guidance_scale: modelParams.evaluated['guidance-scale'],
  };

  const preliminaryCost = getReplicateCost('a10040', 4); // 1.7 seconds average, but we're not taking steps into account here
